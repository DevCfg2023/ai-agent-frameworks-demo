...
async def main():
    ...
    chat = AgentGroupChat(
        ...
        selection_strategy=KernelFunctionSelectionStrategy(
            ...
            ) if result.value[0] is not None else WRITER_NAME,
        ...
        termination_strategy=KernelFunctionTerminationStrategy(
            ...
            kernel=kernel,
            result_parser=lambda result: termination_keyword in str(
    ...
    print(
        "¡Listo! Escribe tu texto, o 'exit' para salir, 'reset' para reiniciar la conversación. "
        "Puedes pasar la ruta de un archivo usando @<ruta_del_archivo>."
    )
